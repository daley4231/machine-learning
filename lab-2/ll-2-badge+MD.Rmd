...
-   The model seemed fairly predictive. It does better near where most students get their final grade. This makes sense based on how the model is trained with less data outside this area. It could be used as an alarm for students more at risk of getting a low final grade. 
...
-   Yes.I would use it in my own classroom. As research, probably not. 

3.  How might the model be improved? Share any ideas you have at this time below:

-   More feature engingeering. 
...
2.  What research questions were the authors of this study trying to address and why did they consider these questions important?
    ...
    -   Sticking with my interest in applying ecology methods to STEM learning ecosystems, the authors ask if improved feature engineering can be used for gut microbiome classification. 

3.  What were the results of these analyses?

    -   They share a pipelie for feature engineering for microbiota classification. 
